...
import { GET_DATA_DETAIL_M010000002 } from "../../../service/api/report";
...
const ReportDetail = (props) => {
  ...
  const goBack = () => {
    props.history.push({
      pathname: `/reports/lane-alarm-statistics-reports/`,
  ...
  const getDataInfo = async (data = null) => {
    ...
    try {
      ...
      const res = await GET_DATA_DETAIL_M010000002(
        dataDetail,
        props.auth.token
      );
  ...
  const handlePrint = useReactToPrint({
    ...
    documentTitle: ["1.2 Lane Alarm Statistics Report Detail"],
  });
      ...
      props: {
        ...
        onClick: () =>
          _exportFileExcel({
            ...
            fileName: "1.2 Lane Alarm Statistics Detail Report",
        ...
        <div className="d-none">
          <PrintReport
            ...
            propsHeader={{
              ...
              TopicText: "1.2 รายละเอียด สถิติการเกิดข้อผิดพลาดของการใช้งานแต่ละช่องทาง"
            }}
          />
        </div>
      </div>
