...
import { GET_DATA_DETAIL_M010000003 } from "../../../service/api/report";
...
const ReportDetail = (props) => {
  ...
  const goBack = () => {
    props.history.push({
      pathname: `/reports/top-5-statistical-opening-hours`,
  ...
  const getDataInfo = async (data = null) => {
    ...
    try {
      setLoading(true);
      const res = await GET_DATA_DETAIL_M010000003(
        dataDetail,
        props.auth.token
      );
  ...
  const handlePrint = useReactToPrint({
    ...
    documentTitle: ["1.3 Top 5 Statistical Opening Hours Report Detail"],
  });
      ...
      props: {
        ...
        onClick: () =>
          _exportFileExcel({
            ...
            fileName: "1.3 Top 5 Statistical Opening Hours Report Detail",
        ...
        <div className="d-none">
          <PrintReport
            ...
            propsHeader={{
              ...
              TopicText: "1.3 รายละเอียด 5 อันดับ ของสถิติจำนวนชั่วโมงการเปิด-ปิด และการหยุดใช้งานของช่องทาง จำแนกรายด่าน รายช่องทาง"
            }}
          />
        </div>
      </div>
