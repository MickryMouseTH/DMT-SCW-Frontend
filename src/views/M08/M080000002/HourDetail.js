...
import { GET_HOUR_DETAIL_M080000002 } from "../../../service/api/report";
...
const HourDetail = (props) => {
    ...
    const columnsOne = [
        ...
        },
        {
            ...
            key: "mpassHourRevenue",
            dataIndex: "mpassHourRevenue",
            align: 'center',
            width: 60,
            render: (value, row, index) => {
                const obj = {
                ...
                if (row.mpassHourRevenue === "") { obj.props.colSpan = 0; obj.props.rowSpan = 1; }
                else { obj.props.colSpan = 1; obj.props.rowSpan = 1; }
                return obj;
            } 
          },
          {
            ...
            key: "easyPassHourRevenue",
            dataIndex: "easyPassHourRevenue",
            align: 'center',
            width: 60,
            render: (value, row, index) => {
                const obj = {
                ...
                if (row.easyPassHourRevenue === "") { obj.props.colSpan = 0; obj.props.rowSpan = 1; }
                else { obj.props.colSpan = 1; obj.props.rowSpan = 1; }
                return obj;
            } 
          },
          {
            ...
            key: "totalHourRevenue",
            dataIndex: "totalHourRevenue",
            align: 'center',
            width: 60,
            render: (value, row, index) => {
                const obj = {
                ...
                if (row.totalHourRevenue === "") { obj.props.colSpan = 0; obj.props.rowSpan = 1; }
                else { obj.props.colSpan = 1; obj.props.rowSpan = 1; }
                return obj;
            } 
          },
    ...
    const addIndex = (res) => {
        ...
        const totalAll = {
            ...
            mpassHourRevenue: res.totalHourMPassRevenue,
            easyPassHourRevenue: res.totalHourEasyPassRevenue,
            totalHourRevenue: res.totalHourRevenue,
        }
    ...
    const getHourDetail = async () => {
        try {
            ...
            const res = await GET_HOUR_DETAIL_M080000002(
            body,
            props.auth.token
            );
    ...
    const goBack = () => {
        props.history.push({
            pathname: `/traffic-and-revenue-by-etc/lane-detail/${dataSource.backLanePath}`,
