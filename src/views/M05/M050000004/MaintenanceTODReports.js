...
import { GET_DATA_INFO_M050000004 } from "../../../service/api/report";
...
const ListOfJobs = (props) => {
  ...
  const handlePrint = useReactToPrint({
    ...
    documentTitle: ["5.4 Maintenance List of Jobs Report"],
  });
  ...
  const getDataInfo = async (data = null) => {
    try {
      setLoading(true);
      const res = await GET_DATA_INFO_M050000004(data, props.auth.token);
      if (res.status.code === "S200") {
        setLoading(false);
      ...
      props: {
        ...
        onClick: () =>
          _exportFileExcel({
            ...
            fileName: "5.4 Maintenance List of Jobs Report",
            header: header35,
            footer: footer35,
          }),
        // disabled: dataSource.list.length < 1,
      ...
      <div>
        ...
        <div className="d-none">
          <PrintReport
            ...
            propsHeader={{
              headerText,
              TopicText: "5.4 รายการปฏิบัติงานของพนักงานโหมดบำรุงรักษา",
            }}
