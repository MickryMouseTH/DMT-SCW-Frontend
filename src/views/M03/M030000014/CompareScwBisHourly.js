...
import { GET_DATA_INFO_HOURLY_M030000014 } from "../../../service/api/report";
import FormDefault from "../../../components/form/FormDefault/FormDefault";

const CompareScwBisHourly = (props) => {
        ...
        return {
          ...
          children: (
            <div
              ...
              onClick={() => {
                history.push({
                  pathname: `/reports/compare-scw-bis-five-minnute/${record.seckey}`,
  ...
  const handleOnClickBack = () => {
    props.history.push({
      pathname: `/reports/compare-scw-bis-daily`,
      value: props.location.value
    });
  };
  ...
  const getData = async () => {
    try {
      ...
      const res = await GET_DATA_INFO_HOURLY_M030000014(
        body,
        props.auth.token
      );
