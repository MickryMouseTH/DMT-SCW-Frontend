...
import { GET_DATA_INFO_M020000004 } from "../../../service/api/report";
...
const HolidayDailyAverageTrafficAndIncome = (props) => {
  ...
  const getDataInfo = async (data = null) => {
    ...
    try {
      setLoading(true);
      const res = await GET_DATA_INFO_M020000004(data, props.auth.token);
  ...
  const handlePrint = useReactToPrint({
    ...
    documentTitle: ["2.4 Holiday Daily Average Traffic And Income Report"]
  });
      ...
      props: {
        ...
        onClick: () =>
          _exportFileExcel({
            ...
            fileName: "2.4 Holiday Daily Average Traffic And Income Report",
            header: header21,
            footer: footer21,
          }),
        // disabled: dataSource.list.length < 1,
        ...
        <div className="d-none">
          <PrintReport
            ...
            propsHeader={{
              ...
              colSpan: 12,
              TopicText: "2.4 ปริมาณจราจรและรายได้เฉลี่ยวันหยุด"
            }}
          />
        </div>
      </div>
