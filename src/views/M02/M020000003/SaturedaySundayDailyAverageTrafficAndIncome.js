...
import { GET_DATA_INFO_M020000003 } from "../../../service/api/report";
import { getPlazaListAPI } from "../../../service/api/util";
import moment from "moment";
const dateFormat = "DD/MM/YYYY";

const SaturedaySundayDailyAverageTrafficAndIncome = (props) => {
  ...
  const getDataInfo = async (data = null) => {
    ...
    try {
      setLoading(true);
      const res = await GET_DATA_INFO_M020000003(data, props.auth.token);
  ...
  const handlePrint = useReactToPrint({
    ...
    documentTitle: ["2.3 Satureday Sunday Daily Average Traffic And Income Report"]
  });
  const action = [
    {
      name: "พิมพ์",
      ...
      props: {
        ...
        onClick: () =>
          _exportFileExcel({
            ...
            fileName: "2.3 Satureday Sunday Daily Average Traffic And Income Report",
            header: header21,
            footer: footer21,
          }),
        // disabled: dataSource.list.length < 1,
        ...
        <div className="d-none">
          <PrintReport
            ...
            propsHeader={{
              ...
              colSpan: 12,
              TopicText: "2.3 ปริมาณจราจรและรายได้เฉลี่ยวันเสาร์ วันอาทิตย์"
            }}
          />
        </div>
      </div>
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(SaturedaySundayDailyAverageTrafficAndIncome);
