...
import { GET_DATA_INFO_M060000007, GET_DATA_EXPORT_M060000007, GET_DATA_BACK_TO_AUDIT_M060000007 } from "../../../service/api/report";
import { getTSBList_API } from "../../../service/api/util";
import moment from "moment";
import { header67 } from "../../../tools/excel/header";
import { footer67 } from "../../../tools/excel/footer";
...
const CompareRevenueShipping = (props) => {
    ...
    const handlePrint = useReactToPrint({
        ...
        documentTitle: ["6.7 Compare Revenue Shipping Companies With System"],
    });
            ...
            props: {
                ...
                onClick: () =>
                    _exportFileExcel({
                        ...
                        fileName: "6.7 Compare Revenue Shipping Companies With System",
                        header: header67,
                        footer: footer67,
                    }),
                // disabled: dataSource.list.length < 1,
    ...
    const ExportToSap = async () => {
        ...
        setLoading(true);
        try {
            const res = await GET_DATA_EXPORT_M060000007(datainfo, props.auth.token)
            if (res.status.code === "S200") {
                Swal.fire({
                    icon: "success",
                    title: "สำเร็จ",
        ...
        <Skeleton loading={loading} active>
            ...
            <div className="d-none">
                <PrintReport
                    ...
                    header={header67}
                    footer={footer67}
                    columnPerPage={header67.length}
                    propsHeader={{
                        headerText,
                        position: "d-flex justify-content-start",
                        colSpan: 12,
                        TopicText: "6.7 เปรียบเทียบรายได้ บริษัทขนส่ง กับ ข้อมูลจจากระบบ (Finance) "
                    }}
