...
import { UPLOAD_FILE_EXCEL_M060000009 } from "../../../service/api/report";
...
const PassingTransactions = (props) => {
    ...
    const handleSubmit = async () => {
        try {
            ...
            const res = await UPLOAD_FILE_EXCEL_M060000009(formData, props.auth.token)
    ...
    return (
        <Skeleton loading={loading} active>
            <Row className='d-flex justify-content-center mt-10'>
                <Text style={{ fontSize: '25px', fontWeight: 'bold' }}>นำเข้าข้อมูล QR จากธนาคารกสิกร</Text>
            </Row>
