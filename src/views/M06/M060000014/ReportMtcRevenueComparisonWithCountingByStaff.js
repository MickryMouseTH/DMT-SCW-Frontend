...
import { GET_DATA_INFO_M060000014 } from "../../../service/api/report";
import {
  // _exportFileExcel, 
  _timeZoneThai, _isEmpty, _isNull, _isZero, _setYearThai
} from "../../../tools/util";
import { exportExcelJs } from "../../../tools/exceljs";
import { header614 } from "../../../tools/excel/header";
...
const ReportMtcRevenueComparisonWithCountingByStaff = (props) => {
  ...
  const headerText = [
    {
      name: "วันที่", value: dataToPrint.DataList ?
      _setYearThai(dataToPrint.DataList.operatorDate,dateFormat) : "",
    },
  ...
  const getDataInfo = async (data = null) => {
    try {
      setLoading(true);
      const res = await GET_DATA_INFO_M060000014(data, props.auth.token);
      if (res.status.code === "S200") {
        setLoading(false);
  ...
  const handlePrint = useReactToPrint({
    ...
    documentTitle: ["6.14 รายงานเปรียบเทียบรายได้ MTC กับบริษัทนับเงิน แยกตามพนักงาน"],
  });
    ...
    },
    {
      ...
      props: {
        ...
        onClick: () =>
          exportExcelJs({
            reportType: "614",
            fileName: "6.14 รายงานเปรียบเทียบรายได้ MTC กับบริษัทนับเงิน แยกตามพนักงาน",
            data: dataSource,
          })
      },
    },
      ...
      <div>
              ...
              return (
                <>
                  <Table.Summary.Row className="bg_default">
                    ...
                    <Table.Summary.Cell colSpan={9} className="text-left" index={4}>
                      <Text></Text>
                    </Table.Summary.Cell>
                  </Table.Summary.Row>
                </>
        ...
        <div className="d-none">
          <PrintReport
            ...
            propsHeader={{
              headerText,
              TopicText: "6.14 รายงานเปรียบเทียบรายได้ MTC กับบริษัทนับเงิน แยกตามพนักงาน",
            }}
            columnPerPage={13}
            rowPerPage={25}
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(ReportMtcRevenueComparisonWithCountingByStaff);
