...
const ImportFileRevenue = (props) => {
    ...
    const handleSubmit = async () => {
        try {
            ...
            const res = await UPLOAD_FILE_EXCEL_M060000001(formData, props.auth.token)
    ...
    return (
        <Skeleton loading={loading} active>
            <Row className='d-flex justify-content-center mt-10'>
                <Text style={{ fontSize: '25px', fontWeight: 'bold' }}>นำเข้าข้อมูล รายงานการตรวจนับประจำวัน จากบริษัทขนส่งเงิน</Text>
            </Row>
