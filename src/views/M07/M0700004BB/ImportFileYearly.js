...
const ImportFileYearly = (props) => {
    ...
    const handleSubmit = async () => {
        try {
            ...
            const res = await UPLOAD_FILE_EXCEL_M0700004BB(formData, props.auth.token)
    ...
    return (
        <Skeleton loading={loading} active>
            <Row className='d-flex justify-content-center mt-10'>
                <Text style={{ fontSize: '25px', fontWeight: 'bold' }}>นำเข้าข้อมูล รายได้ประจำปี</Text>
            </Row>
            ...
            <Row className='d-flex justify-content-center mt-10'>
                <Text style={{ fontSize: '17px', color: 'red' }}>*การนำเข้าข้อมูลชื่อไฟล์เดิมระบบจะลบข้อมูลเดิมแล้วนำเข้าใหม่</Text>
            </Row>
            <Row className='d-flex justify-content-center mt-10'>
                <Text style={{ fontSize: '17px', color: 'red' }}>ตัวอย่างชื่อไฟล์ 'ข้อมูลประมาณรายวันและรายเดือน ปี 2567'</Text>
            </Row>
