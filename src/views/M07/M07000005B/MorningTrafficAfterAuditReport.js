...
import { GET_DATA_INFO_M07000005B } from "../../../service/api/report";
...
const MorningTrafficAfterAuditReport = (props) => {
  ...
  const getDataDailyTollCollction = useCallback(
    async (
      ...
      try {
        setLoading(true);
        const res = await GET_DATA_INFO_M07000005B(
          { date: data.date },
          props.auth.token
        );
        setScrollTable(true)
  ...
  const handlePrint = useReactToPrint({
    ...
    documentTitle: ["7.5.2 รายงานการจราจรหลังตรวจสอบ"]
  });
      ...
      props: {
        ...
        onClick: () =>
          _exportFileExcel({
            ...
            fileName: "7.5.2 รายงานการจราจรหลังตรวจสอบ",
            header: header75B_Export,
          }),
      },
    },
  ];
            ...
            <div className="d-none">
              <PrintPDF ref={printReportRef}
                ...
                HeaderBar={{
                  ...
                  colSpan: 5,
                  TopicText: "7.5.2 รายงานการจราจรหลังตรวจสอบ"
                }}
              />
            </div>
          </Col>
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(MorningTrafficAfterAuditReport);
