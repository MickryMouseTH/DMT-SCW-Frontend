...
import { GET_DATA_INFO_M07000004H } from "../../../service/api/report";
...
const SummaryOfTollVsTrafficReport = (props) => {
  ...
  const getDataInfo = async (data = null) => {
    try {
      setLoading(true);
      const res = await GET_DATA_INFO_M07000004H(data, props.auth.token);
      if (res.status.code === "S200") {
        setLoading(false);
  ...
  const handlePrint = useReactToPrint({
    ...
    documentTitle: ["7.4.8 SUMMARY OF TOLL VS TRAFFIC"],
  });
  ...
  const headerExcel = [
    ...
    { name: "Total Revenue", key: "totalRevenue", type: "nullColumn", align: 'center', className: 'text-right' },
  ]

  const headerPDF = [
    { name: "Period", key: "period", type: "nullColumn", align: 'center', className: 'text-center', width: 70 },
    { name: "Class of Traffic", key: "classOfTraffic", type: "nullColumn", align: 'center', className: 'text-center', width: 40 },
    ...
    { name: "Total Revenue", key: "totalRevenue", type: "nullColumn", align: 'center', className: 'text-right', width: 40 },
  ]
      ...
      props: {
        ...
        onClick: () => {
          _exportFileExcel({
            ...
            fileName: "7.4.8 SUMMARY OF TOLL VS TRAFFIC",
            header: headerExcel,
          });
        },
      },
        ...
        {/* <div className="d-none">
          <PrintPDF
            ...
            HeaderBar={{
              ...
              colSpan: 24,
              TopicText: "7.4.8 SUMMARY OF TOLL VS TRAFFIC"
            }}
          />
        </div> */}
        <div className="d-none">
          <PrintReport
            ...
            rowPerPage={34} //จำนวนเเถวในเเต่ละหน้าของข้อมูล เมื่อ ปริ้น PDF default คือ 10 หากไม่ได้ใส่
          />
        </div>
      </div>
    </Skeleton>
