...
const Header = ({
  ...
  // };
  return (
    <div style={{ fontSize: 12,marginLeft:'0.5px' }} >
      <Row className="pt-5 pb-5">
        <Col
          span={4}
          className="d-flex flex-column align-items-center justify-content-center"
        >
          <img src="/assets/img/brand/logo.jpg" width={40} alt="logo"></img>
        </Col>
        <Col
          span={16}
        ...
        >
          ...
          <p className="mb-0">40/40 ถนนวิภาวดีรังสิต แขวงสนามบิน เขตดอนเมือง กรุงเทพฯ 10210 โทร:(66)(02) 792-6500</p>
        </Col>
      </Row>
