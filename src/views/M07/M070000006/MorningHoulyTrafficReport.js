...
const MorningHoulyTrafficReport = (props) => {
  ...
  const getDataInfo = async (data = null) => {
    try {
      setLoading(true);
      const res = await GET_DATA_INFO_M070000006(data, props.auth.token);
  ...
  const handlePrint = useReactToPrint({
    ...
    documentTitle: ["7.6 รายงานรายได้ทั้งหมดรายวันหลังตรวจสอบ"],
  });

  const headerExcel = [
    { name: "PLAZA", key: "plaza", type: "nullColumn", align: 'center', className: 'text-center' },
    { name: dataSource.headerDay1, key: "revenueDay1Txt", type: "nullColumn", align: 'center', className: 'text-right' },
    { name: dataSource.headerDay2, key: "revenueDay2Txt", type: "nullColumn", align: 'center', className: 'text-right' },
    { name: dataSource.headerDay3, key: "revenueDay3Txt", type: "nullColumn", align: 'center', className: 'text-right' },
    { name: dataSource.headerDay4, key: "revenueDay4Txt", type: "nullColumn", align: 'center', className: 'text-right' },
    { name: dataSource.headerDay5, key: "revenueDay5Txt", type: "nullColumn", align: 'center', className: 'text-right' },
    { name: dataSource.headerDay6, key: "revenueDay6Txt", type: "nullColumn", align: 'center', className: 'text-right' },
    { name: dataSource.headerDay7, key: "revenueDay7Txt", type: "nullColumn", align: 'center', className: 'text-right' }
  ]
      ...
      props: {
        ...
        onClick: () => {
          _exportFileExcel({
            ...
            fileName: "7.6 รายงานรายได้ทั้งหมดรายวันหลังตรวจสอบ",
            header: headerExcel,
          });
        },
      },
        ...
        <div className="d-none">
          <PrintPDF
            ...
            HeaderBar={{
              ...
              colSpan: 6,
              TopicText: "7.6 รายงานรายได้ทั้งหมดรายวันหลังตรวจสอบ"
            }}
          />
        </div>
      </div>
