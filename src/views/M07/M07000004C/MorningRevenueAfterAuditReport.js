...
import { GET_DATA_INFO_M07000004C } from "../../../service/api/report";
...
const MorningRevenueAfterAuditReport = (props) => {
  ...
  const getDataDailyTollCollction = useCallback(
    async (
      ...
      try {
        setLoading(true);
        const res = await GET_DATA_INFO_M07000004C(
          { date: data.date },
          props.auth.token
        );
        setScrollTable(true)
  ...
  const handlePrint = useReactToPrint({
    ...
    documentTitle: ["7.4.3 รายงานรายได้หลังตรวจสอบ"]
  });
      ...
      props: {
        ...
        onClick: () =>
          _exportFileExcel({
            ...
            fileName: "7.4.3 รายงานรายได้หลังตรวจสอบ",
            header: header74A_Export,
          }),
      },
    },
  ];
            ...
            <div className="d-none">
              <PrintPDF ref={printReportRef}
                ...
                HeaderBar={{
                  ...
                  colSpan: 5,
                  TopicText: "7.4.3 รายงานรายได้หลังตรวจสอบ"
                }}
              />
            </div>
          </Col>
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(MorningRevenueAfterAuditReport);
